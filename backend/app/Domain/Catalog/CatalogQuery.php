...
final class CatalogQuery
{
    ...
    {
        // p.sku вторым ключом всегда: без него две позиции с одинаковой
        // ценой лучшего предложения (или одинаковым именем) могли бы менять
        // порядок между запросом total и запросом страницы, а на соседних
        // страницах — теряться или задваиваться. Та же причина, по которой
        // LATERAL выше сортируется по (price_minor, id).
        return match ($sort) {
