...
/**
 * Пул тестовых ключей из ТЗ. Делится между двумя поставщиками через
 * KEYS_OFFSET / KEYS_LIMIT: по умолчанию A получает 30 ключей, B — 20.
 * Маппинга sku → ключ в ТЗ нет, поэтому пул универсальный.
 */
return [
